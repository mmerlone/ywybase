...
| `postcss: 8.5.14`                | Ensure patched version across transitive tree (including Next.js)                                                              | GHSA-qx2v-qp2m-jg93                                           |
...
| `typescript-eslint: 8.57.2`      | Pin transitive eslint-config-next dependency to avoid lint behavior drift while retaining patched brace-expansion via override | Maintenance pin                                               |
